...
class ModelTest extends TestCase
{
    ...
    **/
    ...
    /*   public function testMakeUser() {
            $user = factory(oval\Models\User::class) -> create();
    ...
    */
    ...
    /*    public function testMakeAnnotation() {
        	$annotation = factory(oval\Models\Annotation::class)->create();
        	echo "\n\nANNOTATION:\n";
    ...
    /*	public function testMakeVideo() {
        	$video = factory(oval\Models\Video::class)->create();
    ...
    /*    public function testVideoViewedBy() {
        	factory(oval\Models\User::class, 5) -> create() -> each(function($u) {
        		$u->viewedVideos()->save(factory(oval\Models\Video::class)->create());
        	});

        	$user = oval\Models\User::find(1);
        	echo "\nuser = ".$user->fullName()."\n";
    ...
    */
    ...
    /*    public function testEnrollment() {
            $user = factory(oval\Models\User::class)->create()->each(function($u) {
                echo "user: ".$u->fullName()."\n";
                $u->enrolledIn()->save(factory(oval\Models\Course::class)->make());
    ...
    */
    /*	public function testEnrollUser() {
            ...
            $course = factory(oval\Models\Course::class)->create();
    ...
    */
    /*	public function testCourseInstructors() {
            $user = oval\Models\User::create(array(
                'first_name' => 'John',
                'last_name' => 'Doe',
                'email' => 'admin@oval.com',
                'password' => 'ABC',
            ));
            $course = oval\Models\Course::create(array(
                'name' => 'Test Course 1'
            ));
            echo "\nMake him instructor...";		////
    ...
    /*	public function testMakeGroup() {
            ...
            $group = factory(oval\Models\Group::class)->create();
    ...
    */
    ...
    /*	public function testAddUserToGroupThenRemove() {
            ...
            $group2 = factory(oval\Models\Group::class)->create();
            ...
            $student = factory(oval\Models\User::class)->create();
    ...
    /*public function testGroupVideos() {
        $u1 = factory(oval\Models\User::class)->create();
        $u2 = factory(oval\Models\User::class)->create();

        $g1 = factory(oval\Models\Group::class)->create();
        $g2 = factory(oval\Models\Group::class)->create();

        $v1 = factory(oval\Models\Video::class)->create();
        $v2 = factory(oval\Models\Video::class)->create();
        $v3 = factory(oval\Models\Video::class)->create();
        $v4 = factory(oval\Models\Video::class)->create();
        $v5 = factory(oval\Models\Video::class)->create();
        $v6 = factory(oval\Models\Video::class)->create();
    ...
    /*public function testRelationships() {
        $u = factory(oval\Models\User::class)->create();
        ...
        echo oval\Models\Course::find(2)->name;
...
// 		echo $u->groupMemberOf->where('course_id', '1');
    ...
    /*function testVideosAdded() {
        $minnie = oval\Models\User::find(2);
        $this->be($minnie);
    ...
    public function testIsInstructor()
    {
        $minnie = oval\Models\User::find(2);
        $this->be($minnie);
        echo "minnie is instructor of course(1) = ".$minnie->isInstructorOf(oval\Models\Course::find(1));
    }
