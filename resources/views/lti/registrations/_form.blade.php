                ...
                <div class="col-xs-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="lti-registration-name" class="form-control gray-textbox"
                            name="name" value="{{ isset($registration) ? $registration->name : "" }}">
                    </div><!-- form-group -->

                    <div class="form-group">
                        <label for="registration-issuer">Issuer</label>
                        <input type="text" id="lti-registration-issuer" class="form-control gray-textbox"
                            name="issuer" placeholder="https://lift.c3l.ai" value="{{ isset($registration) ? $registration->issuer : "" }}">
                    </div><!-- form-group -->
                        ...
                        <input type="text" id="registration-client-id" class="form-control gray-textbox"
                            name="client_id" value="{{ isset($registration) ? $registration->client_id : "" }}">
                    </div><!-- form-group -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="registration-registration-id" class="form-control gray-textbox"
                            name="deployment_id" value="{{ isset($registration) ? $registration->deployment_id : "" }}">
                    </div><!-- form-group -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="registration-keyset-url" class="form-control gray-textbox"
                            name="keyset_url" value="{{ isset($registration) ? $registration->keyset_url : "" }}">
                    </div><!-- form-group -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="registration-auth-login-url" class="form-control gray-textbox"
                            name="auth_login_url" value="{{ isset($registration) ? $registration->auth_login_url : "" }}">
                    </div><!-- form-group -->
                </div><!-- col -->
            </div><!-- row -->
