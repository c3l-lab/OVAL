            ...
            <div class="modal-body container-fluid">
                <form id="assign-video-to-group-form" role="form" data-toggle="validator">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div id="assign-to-course" class="btn-group col-xs-12">
                                ...
                                <button type="button" class="btn dropdown-button dropdown-center"
                                    id="modal-course-name" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false"></button>
                                <button type="button" class="btn dropdown-button dropdown-toggle"
                    ...
                    <div class="row space-top">
                        <div class="col-xs-12">
                            ...
                            <span class="">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="copy-contents" id="copy-contents-no" value="false"
                                        checked>No
                                </label>
                            </span>
                        </div><!-- col-xs-12 -->
                    ...
                    <div class="form-buttons">
                        <button type="button" class="btn btn-link center-block" id="assign-to-group"><i
...
<div class="modal fade" id="modal-points-form" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body container-fluid">
                <form>
                    ...
                    <div class="row form-group space-top-30">
                        <div class="col-xs-12">
                            <fieldset class="space-bottom">
                                ...
                                <input id="modal-point-instruction" class="form-control"
                                    placeholder="Enter instruction for students..." type="text">
                            </fieldset>
                            <fieldset id="modal-points">
                                <label>Points:</label>
                                <div class="row">
                                    <div class="col-xs-10">
                                        <input class="form-control new-point" type="text"
                                            placeholder="Enter Video Key Point text...">
                                    </div><!-- col-xs-10 -->
                                    <div class="col-xs-2">
                                        <button class="modal-delete-point btn-sm outline-button full-width"
                            ...
                            <button id="modal-another-point" class="btn-sm outline-button" type="button"
                    ...
                    <div class="form-buttons">
                        <button type="button" class="btn btn-link" id="save-points"><i
                                class="fa fa-save"></i></button>
                        <button type="button" class="btn btn-link pull-right" id="delete-points"><i
...
<div class="modal fade" id="quiz_create_modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body container-fluid">
                <div class="player_wrap">
                    ...
                    <br>
                    <p class="quiz_hint"><i class="fa fa-info-circle" aria-hidden="true"></i> Pause video to create
                        new quiz</p>
                </div>
                ...
                <div class="container-fluid create_new_quiz_wrap" style="display:none;">
                    <h2><i class="fa fa-plus-square" aria-hidden="true"></i> <span id='create_quiz_time_title'>CREATE
                            NEW QUIZ @</span> <span id='create_quiz_time'></span></h2>

                    <div class="container-fluid col-xs-4 question_warp">
                        <ul>
                            <div><span class="title">Question List</span><i class="fa fa-caret-down"
                                    aria-hidden="true" id="quiz_list_toggle_btn"></i></div>
                            <ul>
        ...
        <li>Question 20<i class="fa fa-trash-o" aria-hidden="true"></i></li> -->
           ...
           <td><input type="text" value=""></input></td>
                ...
                <div class="container-fluid quiz_warp">
                    ...
                    <ul>
                        <div><span class="title"> Quiz List &nbsp;&nbsp;</span><i class="fa fa-caret-down"
                                aria-hidden="true" id="question_list_toggle_btn"></i></div>
                        <ul>
...
<div id="pop_out_dialog" class="modal fade" tabindex="-1" style="display: none;">
    <div class="modal-dialog" role="document" style="width:80%;">
        <div class="modal-content">
            ...
            <div>
                <button type="button" class="btn btn-link center-block quiz_submit_btn" id="skip_tutorial">Skip
                    Tutorial <i class="fa fa-ban" aria-hidden="true"></i></button>
            </div>
...
<div class="modal fade" id="visibility-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body container-fluid">
                <form id="visibility-form">
                    ...
                    <div class="form-buttons">
                        <button type="submit" class="btn btn-link center-block" id="save-visibility"><i
...
<div class="modal fade" id="order-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body container-fluid">
                ...
                <form id="order-form">
                    ...
                    <div class="form-buttons">
                        <button type="submit" class="btn btn-link center-block" id="save-order"><i
                                class="fa fa-save" aria-hidden="true"></i></button>
                    </div><!-- form-buttons -->
                </form>
            </div><!-- modal-body -->
...
<div class="modal fade" id="text-analysis-modal" tabindex="-1" role="dialog"
    aria-labelledby="text-analysis-title" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body container-fluid">
                <form id="text-analysis-form">
                    ...
                    <div class="form-buttons">
                        <button type="submit" class="btn btn-link center-block" id="save-analysis-vis"><i
                                class="fa fa-save" aria-hidden="true"></i></button>
                    </div><!-- form-buttons -->
                </form>
            </div><!-- modal-body -->
...
<div class="modal fade" id="transcript-form" tabindex="-1" role="dialog" aria-labelledby="transcript-modal-title"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body container-fluid">
                <form id="upload-transcript-form" method="POST" action="{{ route('transcripts.store') }}"
                    enctype="multipart/form-data" role="form" data-toggle="validator">
                    {{ csrf_field() }}
                    <input type="hidden" name="video_id" />
                    <div class="form-group">
                        <label for="transcript-file">Please select file to upload...</label>
                        <input type="file" id="transcript-file" name="file" data-filetype="srt"
                            data-required-error="Please select a file in .srt format" required>
                        <div class="help-block with-errors"></div>
                    </div><!-- form-group -->
...
<div class="modal fade" id="edit-keywords-modal" tabindex="-1" role="dialog"
    aria-labelledby="edit-keywords-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div class="modal fade" id="modal-assigned-group-list" tabindex="-1" role="dialog"
    aria-labelledby="assigned-groups-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body container-fluid">
                ...
                <div class="row">
                    <div class="btn-group col-xs-12">
                        <button type="button" class="btn dropdown-button dropdown-left">Course</button>
                        <button type="button" class="btn dropdown-button dropdown-center"
                            id="assigned-groups-course-name" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"></button>
                        <button type="button" class="btn dropdown-button dropdown-toggle" data-toggle="dropdown"
...
@include('group_videos.index._annotation_config_modal')
